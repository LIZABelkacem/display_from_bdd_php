...
$pdoStat = $objetPdo -> prepare ('SELECT * From code_projet');
   ...
   <div class ="container flex" >  
         ...
         <table>
                    <tr>    
                        ...
                        <td> <?= $sous_code['montant_code_projet']?>      </td>
                        <td> <a href= "suppression_form.php?numCodeProjet= <?= $sous_code['id']?>"> Supprimer </a>    </td>
                        <td>  <a href= "modification_form.php?numCodeProjet= <?= $sous_code['id']?>"> Modifier </a>   </td>
